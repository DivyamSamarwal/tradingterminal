...
var marketStocks = [
	...
	mkStock("WHEAT", "Wheat (USD/bu)", 5.8, 0.015, "Agriculture", "COMM", "USD"),
	mkStock("CORN", "Corn (USD/bu)", 4.2, 0.012, "Agriculture", "COMM", "USD"),
	mkStock("SOYBEAN", "Soybeans (USD/bu)", 11.5, 0.018, "Agriculture", "COMM", "USD"),
	mkStock("COFFEE", "Coffee (USD/lb)", 2.1, 0.02, "Agriculture", "COMM", "USD"),
	mkStock("SUGAR", "Sugar (USD/lb)", 0.20, 0.025, "Agriculture", "COMM", "USD"),
	mkStock("POWER", "Electricity (USD/MWh)", 45.0, 0.03, "Energy", "COMM", "USD"),
	mkStock("CARBON", "Carbon Credits (EUR/ton)", 65.0, 0.025, "Energy", "COMM", "EUR"),
	mkStock("URANIUM", "Uranium (USD/lb)", 90.0, 0.015, "Energy", "COMM", "USD"),
	// ── Forex (FX) ──
...
function openFixedDeposit() {
	...
	if (dalalStock) {
		var pumpVal = (amt / 100000) * 0.00002;
