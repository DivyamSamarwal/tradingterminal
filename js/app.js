...
var CIRCUIT_LIMIT = 0.1; // 10% upper/lower circuit
...
var marketStocks = [
	...
	mkStock("HDFCBANK", "HDFC Bank Ltd", 1755, 0.002, "Banking"),
	mkStock("SBIN", "State Bank of India", 715, 0.003, "Banking"),
	...
	mkStock("HCLTECH", "HCL Technologies", 1720, 0.002, "IT"),
	mkStock("WIPRO", "Wipro Ltd", 295, 0.0026, "IT"),
	mkStock("TECHM", "Tech Mahindra Ltd", 1685, 0.0022, "IT"),
	mkStock("LTIM", "LTIMindtree Ltd", 5150, 0.002, "IT"),
	// ── Energy & Conglomerate ──
	...
	// ── Infra ──
	mkStock("ADANIENT", "Adani Enterprises", 2185, 0.004, "Infra"),
	mkStock("LT", "Larsen & Toubro", 3255, 0.0016, "Infra"),
	mkStock("BEL", "Bharat Electronics Ltd", 255, 0.003, "Infra"),
	// ── Auto ──
	...
	mkStock("CIPLA", "Cipla Ltd", 1555, 0.002, "Pharma"),
	...
	// ── FMCG ──
	mkStock("ITC", "ITC Ltd", 415, 0.001, "FMCG"),
	...
	// ── Telecom ──
	mkStock("BHARTIARTL", "Bharti Airtel", 1730, 0.002, "Telecom"),
	// ── Consumer ──
	mkStock("TITAN", "Titan Company Ltd", 3155, 0.0018, "Consumer"),
	// ── Cement ──
	mkStock("ULTRACEMCO", "UltraTech Cement Ltd", 10300, 0.0016, "Cement"),
	// ── New Age Tech ──
	mkStock("ZOMATO", "Zomato Ltd", 235, 0.005, "Tech"),
	mkStock("PAYTM", "One97 Communications", 855, 0.006, "Tech"),
	mkStock("IRCTC", "IRCTC Ltd", 775, 0.003, "Tech"),
	...
	mkStock("NVDA", "NVIDIA Corp.", 177, 0.004, "Semicon", "NASDAQ", "USD"), // post 10:1 split Jun'24
	mkStock("TSLA", "Tesla Inc.", 403, 0.0055, "EV", "NASDAQ", "USD"),
	mkStock("META", "Meta Platforms", 648, 0.003, "SocMedia", "NASDAQ", "USD"),
	mkStock("GOOGL", "Alphabet Inc.", 311, 0.002, "Tech", "NASDAQ", "USD"),
	...
	mkStock("AVGO", "Broadcom Inc.", 320, 0.003, "Semicon", "NASDAQ", "USD"),
	mkStock("COIN", "Coinbase Global", 176, 0.007, "Crypto", "NASDAQ", "USD"),
	mkStock(
		"PLTR",
	...
	mkStock("MU", "Micron Technology", 412, 0.004, "Semicon", "NASDAQ", "USD"),
	// ── SSE (Shanghai) ──  (CNY)
	...
	mkStock("CMBANK", "China Merchants Bank", 48, 0.002, "Banking", "SSE", "CNY"),
	mkStock("PINGAN", "Ping An Insurance", 52, 0.0022, "Insurance", "SSE", "CNY"),
	mkStock("PETROCH", "PetroChina Co.", 10.8, 0.002, "Energy", "SSE", "CNY"),
	mkStock("BYD", "BYD Co. Ltd.", 285, 0.0035, "EV", "SSE", "CNY"),
	mkStock("CATL", "CATL (CATLSH)", 242, 0.0032, "EV Battery", "SSE", "CNY"),
	mkStock("LONGI", "LONGi Green Energy", 18, 0.004, "Solar", "SSE", "CNY"),
	...
	mkStock("CANON7751", "Canon Inc.", 4250, 0.002, "Tech", "TSE", "JPY"),
	...
	mkStock("HITACHI", "Hitachi Ltd.", 13500, 0.002, "Industrial", "TSE", "JPY"),
	mkStock("MITSUI", "Mitsui & Co.", 7200, 0.0025, "Trading", "TSE", "JPY"),
	mkStock("NIDEC", "Nidec Corp.", 6800, 0.003, "Components", "TSE", "JPY"),
	// ── European (EU) ── (EUR / GBP)
	mkStock("LVMH", "LVMH Moet Hennessy", 780, 0.002, "Luxury", "EU", "EUR"),
	mkStock("ASML", "ASML Holding N.V.", 850, 0.0025, "Tech", "EU", "EUR"),
	mkStock("SAP", "SAP SE", 160, 0.0022, "Tech", "EU", "EUR"),
	mkStock("SIEMENS", "Siemens AG", 175, 0.002, "Industrial", "EU", "EUR"),
	mkStock("LOREAL", "L'Oreal S.A.", 420, 0.0018, "Consumer", "EU", "EUR"),
	mkStock("AZN", "AstraZeneca PLC", 10500, 0.0022, "Pharma", "EU", "GBP"),
	mkStock("SHEL", "Shell PLC", 2650, 0.002, "Energy", "EU", "GBP"),
	...
	mkStock("GBPUSD", "GBP/USD", 1.25, 0.002, "Currency", "FX", "USD"),
	mkStock("USDJPY", "USD/JPY", 155.5, 0.0025, "Currency", "FX", "JPY"),
	mkStock("AUDUSD", "AUD/USD", 0.65, 0.002, "Currency", "FX", "USD"),
	mkStock("USDCAD", "USD/CAD", 1.37, 0.0018, "Currency", "FX", "USD"),
	mkStock("USDINR", "USD/INR", 91.03, 0.0015, "Currency", "FX", "INR"),
	mkStock("CNYINR", "CNY/INR", 13.28, 0.002, "Currency", "FX", "INR"),
...
var newsEvents = [
	...
	{
		text: "Crude oil surges 5%. Import-heavy sectors face headwinds.",
		impact: -0.015,
		target: "ALL",
	},
	{
		text: "India GDP growth beats estimates at 7.6%. Market rallies on optimism.",
		impact: 0.018,
		target: "ALL",
	},
	{
	...
	{
		text: "VIX spikes 20%. Fear gauge signals extreme volatility ahead.",
		impact: -0.015,
		target: "ALL",
	},
	...
	// ---- BANKING ----
	{
		text: "RBI keeps repo rate unchanged at 6.5%. Banks rally on status quo.",
		impact: 0.015,
		target: "BANK",
	},
	{
	...
	{
		text: "HDFC Bank Q4 results: NII up 24%, asset quality improves.",
		impact: 0.03,
		target: "HDFCBANK",
	},
	{
	...
	{
		text: "Global tech rout weighs on Indian IT. NASDAQ down 3%.",
		impact: -0.02,
		target: "IT",
	},
	{
	...
	{
		text: "Infosys raises FY guidance: revenue growth at 13-15%.",
		impact: 0.028,
		target: "INFY",
	},
	{
		text: "HCL Tech cloud revenue grows 40%. Multi-year deal pipeline strong.",
		impact: 0.02,
		target: "HCLTECH",
	},
	{
	...
	// ---- INFRA ----
	{
		text: "Government announces capex boost. Infra spending up 30% YoY.",
		impact: 0.02,
		target: "INFRA",
	},
	{
	...
	// ---- AUTO ----
	{
		text: "Auto sales surge 15% MoM. Sector outperforms on festive demand.",
		impact: 0.025,
		target: "AUTO",
	},
	{
	...
	{
		text: "GST on hybrid cars reduced from 28% to 18%. Auto rally.",
		impact: 0.022,
		target: "AUTO",
	},
	...
	{
		text: "Coal India production up 15% in Q3. Record coal dispatch achieved.",
		impact: 0.02,
		target: "COALINDIA",
	},
	{
	...
	{
		text: "Iron ore prices crash 12%. Steel margins under severe pressure.",
		impact: -0.025,
		target: "METAL",
	},
	...
	{
		text: "Airtel raises tariffs by 15%. ARPU improvement expected.",
		impact: 0.025,
		target: "BHARTIARTL",
	},
	{
	...
	{
		text: "Rural demand recovery drives FMCG volume growth to 8%.",
		impact: 0.015,
		target: "FMCG",
	},
	{
	...
	// ---- NEW AGE / TECH ----
	{
		text: "Zomato quick commerce grows 80% QoQ. Blinkit leads market.",
		impact: 0.04,
		target: "ZOMATO",
	},
	{
	...
	{
		text: "Zomato insider selling: Promoter offloads 2% stake via block deal.",
		impact: -0.03,
		target: "ZOMATO",
	},
	...
	// ---- RANDOM / GENERIC ----
	{
		text: "Earnings beat for {name}! Revenue up 22% YoY. Margins expand.",
		impact: 0.025,
		target: "RANDOM",
	},
	{
	...
	{
		text: "Block deal: Institutional investor buys {name} at 3% premium to CMP.",
		impact: 0.015,
		target: "RANDOM",
	},
	{
	...
	{
		text: "Profit booking in {name} after 15% rally in 5 sessions.",
		impact: -0.025,
		target: "RANDOM",
	},
	{
		text: "Analyst upgrade: {name} target price raised 20% by Goldman Sachs.",
		impact: 0.02,
		target: "RANDOM",
	},
	{
	...
	{
		text: "Insider buying detected in {name}. Promoter raises stake by 1.2%.",
		impact: 0.018,
		target: "RANDOM",
	},
	{
		text: "Promoter pledge in {name} rises to 35%. Market concerned.",
		impact: -0.022,
		target: "RANDOM",
	},
	{
		text: "Mutual fund holdings in {name} increase by 3% this quarter.",
		impact: 0.012,
		target: "RANDOM",
	},
	{
	...
	// ---- ADDITIONAL MACRO ----
	{
		text: "India CPI inflation drops to 4.2%. Monetary easing hopes rise.",
		impact: 0.016,
		target: "ALL",
	},
	{
	...
	{
		text: "US 10-year bond yield crosses 5%. Global equity rout intensifies.",
		impact: -0.022,
		target: "ALL",
	},
	{
	...
	{
		text: "Gold hits all-time high above $2,800/oz. Safe haven demand surges.",
		impact: -0.006,
		target: "ALL",
	},
	{
	...
	{
		text: "ICICI Bank net profit jumps 35%. Best quarterly performance in 5 years.",
		impact: 0.03,
		target: "ICICIBANK",
	},
	{
	...
	{
		text: "Axis Bank NPA ratio improves to 1.4%. Clean-up cycle nearing end.",
		impact: 0.02,
		target: "AXISBANK",
	},
	{
	...
	{
		text: "NTPC Green Energy IPO listing at 30% premium. Parent stock rallies.",
		impact: 0.02,
		target: "NTPC",
	},
	{
		text: "Power Grid dividend yield at 5%. Defensive pick in volatile market.",
		impact: 0.01,
		target: "POWERGRID",
	},
	{
	...
	{
		text: "Gas price revision: APM price hiked 10%. Upstream companies benefit.",
		impact: 0.018,
		target: "ENERGY",
	},
	{
	...
	// ---- ADDITIONAL AUTO ----
	{
		text: "Maruti Q3 profit surges 42%. SUV mix at all-time high of 60%.",
		impact: 0.03,
		target: "MARUTI",
	},
	{
		text: "Tata Motors JLR margins expand to 8.5%. Best in 4 years.",
		impact: 0.028,
		target: "TATAMOTORS",
	},
	{
	...
	{
		text: "Auto insurance costs rise 20%. Negative for auto demand outlook.",
		impact: -0.012,
		target: "AUTO",
	},
	{
	...
	{
		text: "Airtel Africa revenue grows 22%. International ops becoming significant.",
		impact: 0.018,
		target: "BHARTIARTL",
	},
	{
		text: "TRAI mandates 20% tariff cut for basic plans. Revenue impact feared.",
		impact: -0.02,
		target: "TELECOM",
	},
	{
	...
	// ---- ADDITIONAL FMCG ----
	{
		text: "Hindustan Unilever premium portfolio grows 25%. Premiumization trend strong.",
		impact: 0.018,
		target: "HINDUNILVR",
	},
	{
	...
	{
		text: "Road construction pace drops 15%. Labour shortage impacts projects.",
		impact: -0.015,
		target: "INFRA",
	},
	{
	...
	{
		text: "Warren Buffett's Berkshire takes 2% stake in {name}. Global attention.",
		impact: 0.04,
		target: "RANDOM",
	},
	{
	...
	{
		text: "Foreign broker initiates coverage on {name} with BUY. Target 40% upside.",
		impact: 0.025,
		target: "RANDOM",
	},
	{
	...
	{
		text: "{name} ROCE improves to 22%. Capital efficiency gains noted by analysts.",
		impact: 0.018,
		target: "RANDOM",
	},
	{
	...
	{
		text: "{name} dividend yield at 4.5%. Attractive for income investors.",
		impact: 0.01,
		target: "RANDOM",
	},
	{
	...
	{
		text: "Bulk deal: Singapore sovereign fund buys 1.5% of {name}.",
		impact: 0.02,
		target: "RANDOM",
	},
	{
		text: "{name} management guides for 30% profit growth in FY26.",
		impact: 0.025,
		target: "RANDOM",
	},
	{
	...
	{
		text: "M&M farm equipment segment: tractor volumes up 18% YoY.",
		impact: 0.015,
		target: "MM",
	},
	{
	...
	{
		text: "Cipla chronic care portfolio growing 24% YoY. Branded generics outperform.",
		impact: 0.02,
		target: "CIPLA",
	},
	{
	...
	{
		text: "Britannia Q3 profit beats estimates by 18%. Volume recovery on rural demand.",
		impact: 0.025,
		target: "BRITANNIA",
	},
	{
		text: "Nestle India Maggi noodle market share hits all-time high of 58%.",
		impact: 0.022,
		target: "NESTLEIND",
	},
	{
		text: "Nestle India premium portfolio (Munch, KitKat) revenue up 28% YoY.",
		impact: 0.018,
		target: "NESTLEIND",
	},
	{
	...
	// ---- ENERGY / OIL & GAS (NEW) ----
	{
		text: "ONGC discovers new deepwater gas field in Bay of Bengal. Reserves +8%.",
		impact: 0.03,
		target: "ONGC",
	},
	{
		text: "ONGC Q3 profit beats: crude realization at $82/bbl. Dividend announced.",
		impact: 0.025,
		target: "ONGC",
	},
	{
	...
	{
		text: "Global crude oil drops below $70/bbl. OMCs rally on marketing margin expansion.",
		impact: 0.025,
		target: "OILGAS",
	},
	{
	...
	{
		text: "Crude oil spikes to $95/bbl. Refinery margins squeezed. ONGC benefits.",
		impact: -0.02,
		target: "BPCL",
	},
	...
	{
		text: "India cement demand grows 10% in Q3. Infra + housing demand robust.",
		impact: 0.02,
		target: "CEMENT",
	},
	{
	...
	{
		text: "Gold prices rally 12% YTD. Titan margin expansion on studded ratio.",
		impact: 0.022,
		target: "TITAN",
	},
	{
	...
	{
		text: "NBFC credit growth at 22%. Bajaj Finance and Finserv set to benefit.",
		impact: 0.018,
		target: "BAJAJFINSV",
	},
	...
	{
		text: "Tech Mahindra CEO outlines turnaround. EBIT margin to reach 15% by FY26.",
		impact: 0.025,
		target: "TECHM",
	},
	{
		text: "LTIMindtree BFSI vertical grows 28% YoY. Deal wins at record $1.2B TCV.",
		impact: 0.03,
		target: "LTIM",
	},
	{
	...
	{
		text: "IT stocks rally as US Fed cuts rates. ITES stocks up 3-5% in a day.",
		impact: 0.02,
		target: "IT",
	},
	...
	{
		text: "Paytm UPI market share rebounds to 12% after regulatory pause.",
		impact: 0.03,
		target: "PAYTM",
	},
	{
		text: "Paytm founder increases stake to 20.5%. Confidence signal.",
		impact: 0.025,
		target: "PAYTM",
	},
	{
		text: "IRCTC announces dynamic pricing for premium trains. Revenue impact +18%.",
		impact: 0.028,
		target: "IRCTC",
	},
	{
	...
	{
		text: "IRCTC Q3 profit up 35% YoY. Rail tourism segment doubles.",
		impact: 0.03,
		target: "IRCTC",
	},
	...
	{
		text: "RBI cuts repo rate by 25bps to 6.25%. Rate-sensitive sectors rally hard.",
		impact: 0.025,
		target: "ALL",
	},
	{
	...
	{
		text: "India retail inflation hits 4-year low at 3.8%. Rate cut cycle likely.",
		impact: 0.02,
		target: "ALL",
	},
	{
	...
	{
		text: "Bank credit growth slows to 12%. Concerns of tightening credit cycle.",
		impact: -0.012,
		target: "BANK",
	},
	{
	...
	{
		text: "Dollar index surges to 108. EM currencies under pressure including rupee.",
		impact: -0.018,
		target: "ALL",
	},
	{
	...
	{
		text: "Dalal Street Inc posts record breaking quarter. Earnings smash expectations by 40%.",
		impact: 0.05,
		target: "DALAL",
	},
	{
	...
	// ---- WAR / GEOPOLITICAL ----
	{
		text: "Russia-Ukraine conflict escalates. European gas prices spike 30%. Markets risk-off.",
		impact: -0.018,
		target: "ALL",
		market: "WAR",
	},
	...
	{
		text: "Oil tanker attacked in Red Sea. Crude surges $8/bbl on supply fears.",
		impact: -0.02,
		target: "ENERGY",
		market: "WAR",
	},
	...
	{
		text: "North Korea fires ballistic missiles over Japan. Nikkei drops 2%.",
		impact: -0.02,
		target: "ALL",
		market: "WAR",
	},
	...
	{
		text: "War premium in gold prices rises $150/oz. Safe haven demand surges.",
		impact: 0.035,
		target: "GOLD",
		market: "WAR",
	},
	...
	{
		text: "Microsoft Azure revenue grows 33% YoY. AI workload demand explosively.",
		impact: 0.025,
		target: "MSFT",
		market: "NASDAQ",
	},
	...
	{
		text: "Meta AI ad revenue surges 40%. Largest quarter in company history.",
		impact: 0.035,
		target: "META",
		market: "NASDAQ",
	},
	...
	{
		text: "Amazon AWS profitability hits all-time high. Operating margin crosses 38%.",
		impact: 0.03,
		target: "AMZN",
		market: "NASDAQ",
	},
	...
	{
		text: "Fed cuts rates 25bps. NASDAQ 100 rallies 2.5% on liquidity hopes.",
		impact: 0.022,
		target: "ALL_NASDAQ",
		market: "NASDAQ",
	},
	{
		text: "US CPI surprise: inflation at 3.8%. Rate cut hopes fade, tech sells off.",
		impact: -0.02,
		target: "ALL_NASDAQ",
		market: "NASDAQ",
	},
	{
		text: "US recession fears mount. NASDAQ 100 drops 4% on PMI miss.",
		impact: -0.028,
		target: "ALL_NASDAQ",
		market: "NASDAQ",
	},
	...
	{
		text: "China Q3 GDP growth beats at 5.4%. Market rally on economic recovery.",
		impact: 0.03,
		target: "ALL_SSE",
		market: "SSE",
	},
	...
	{
		text: "ICBC bad loan ratio rises to 1.8%. Property sector NPAs rise.",
		impact: -0.02,
		target: "ICBC",
		market: "SSE",
	},
	{
		text: "ICBC dividend yield at 6.5%. Value investors accumulate.",
		impact: 0.015,
		target: "ICBC",
		market: "SSE",
	},
	...
	{
		text: "Ping An Insurance dividend increased 15%. Record payout.",
		impact: 0.02,
		target: "PINGAN",
		market: "SSE",
	},
	...
	{
		text: "US-China trade war re-escalates. 60% tariffs on Chinese goods.",
		impact: -0.035,
		target: "ALL_SSE",
		market: "SSE",
	},
	...
	{
		text: "Bank of Japan raises rates to 1.0%. Yen strengthens, Nikkei corrects.",
		impact: -0.025,
		target: "ALL_TSE",
		market: "TSE",
	},
	{
		text: "Japan GDP growth surprises at 3.1% annualized. Nikkei rally.",
		impact: 0.02,
		target: "ALL_TSE",
		market: "TSE",
	},
	...
	// ---- COMMODITIES ----
	{
		text: "Gold hits all-time high $3,050/oz. War fears drive safe haven demand.",
		impact: 0.028,
		target: "GOLD",
		market: "COMM",
	},
	{
		text: "Gold falls $120/oz as US dollar strengthens sharply.",
		impact: -0.02,
		target: "GOLD",
		market: "COMM",
	},
	...
	{
		text: "Silver industrial demand from EVs grows 30% YoY. Supply deficit.",
		impact: 0.025,
		target: "SILVER",
		market: "COMM",
	},
	...
	{
		text: "Copper prices jump 8% on China infrastructure stimulus news.",
		impact: 0.028,
		target: "COPPER",
		market: "COMM",
	},
	{
		text: "Copper mine strike in Chile halts 15% of global production.",
		impact: 0.035,
		target: "COPPER",
		market: "COMM",
	},
	...
	{
		text: "Aluminium supply glut: China production surge leads to 10% price crash.",
		impact: -0.038,
		target: "ALUM",
		market: "COMM",
	},
	...
	{
		text: "Zinc mine closure in Peru disrupts 8% of global supply.",
		impact: 0.028,
		target: "ZINC",
		market: "COMM",
	},
	...
	{
		text: "Natural gas futures spike 10% on severe winter storm forecast.",
		impact: 0.055,
		target: "NATGAS",
		market: "COMM",
	},
	...
	{
		text: "Global crypto adoption hits 10% milestone. Strong retail buying.",
		impact: 0.03,
		target: "ALL_CRYPTO",
		market: "CRYPTO",
	},
	...
	{
		text: "AMD Ryzen 9000 series captures 35% consumer CPU market share. Intel losing ground.",
		impact: 0.028,
		target: "AMD",
		market: "NASDAQ",
	},
	...
	{
		text: "Adobe Creative Cloud price increases 10%. Wall Street cheers margin expansion.",
		impact: 0.025,
		target: "ADBE",
		market: "NASDAQ",
	},
	...
	{
		text: "Crypto winter hits Coinbase: trading revenue drops 60% QoQ on low volatility.",
		impact: -0.04,
		target: "COIN",
		market: "NASDAQ",
	},
	...
	{
		text: "Palantir AIP commercial revenue grows 55% YoY. Boot camp model driving enterprise deals.",
		impact: 0.04,
		target: "PLTR",
		market: "NASDAQ",
	},
	...
	{
		text: "Micron raises Q3 guidance: data center DRAM pricing up 30%. Memory supercycle.",
		impact: 0.04,
		target: "MU",
		market: "NASDAQ",
	},
	...
	{
		text: "PC DRAM oversupply hits Micron. Spot prices down 18%. Margin pressure.",
		impact: -0.03,
		target: "MU",
		market: "NASDAQ",
	},
	...
	{
		text: "Mag-7 earnings season: all 7 companies beat estimates. NASDAQ rallies 3%.",
		impact: 0.03,
		target: "ALL_NASDAQ",
		market: "NASDAQ",
	},
	...
	{
		text: "US Treasury yield drops to 4.1%. Growth stocks re-rate higher.",
		impact: 0.02,
		target: "ALL_NASDAQ",
		market: "NASDAQ",
	},
	...
	{
		text: "SAIC Motor EV sales jump 30% in Europe.",
		impact: 0.022,
		target: "SAIC",
		market: "SSE",
	},
	...
	{
		text: "Agricultural Bank of China expands rural lending by 15%.",
		impact: 0.018,
		target: "AGBANK",
		market: "SSE",
	},
	...
	{
		text: "Solar panel oversupply crisis: LONGi cuts ASP guidance by 15%.",
		impact: -0.03,
		target: "LONGI",
		market: "SSE",
	},
	...
	{
		text: "SAIC-GM joint venture sales drop 40% YoY. ICE vehicle demand collapses.",
		impact: -0.03,
		target: "SAIC",
		market: "SSE",
	},
	...
	{
		text: "Fast Retailing raises FY profit guidance 15%. Overseas same-store sales +18%.",
		impact: 0.03,
		target: "FASTRET",
		market: "TSE",
	},
	...
	{
		text: "Keyence Q3 operating margin at 55%. World-class profitability sustained.",
		impact: 0.025,
		target: "KEYENCE",
		market: "TSE",
	},
	...
	{
		text: "Canon semiconductor lithography equipment orders surge 40% on AI chip demand.",
		impact: 0.03,
		target: "CANON7751",
		market: "TSE",
	},
	{
		text: "Canon mirrorless camera R6 III sells out globally. Camera segment revenue up 22%.",
		impact: 0.018,
		target: "CANON7751",
		market: "TSE",
	},
	...
	{
		text: "Tokyo Stock Exchange corporate governance reforms: 80% of listed firms now buy back shares.",
		impact: 0.02,
		target: "ALL_TSE",
		market: "TSE",
	},
	...
	{
		text: "Japan core inflation hits 3.5%. BOJ signals faster pace of rate normalization.",
		impact: -0.018,
		target: "ALL_TSE",
		market: "TSE",
	},
	{
		text: "Warren Buffett increases Japan trading house stake to 9.9%. Nikkei rally.",
		impact: 0.025,
		target: "ALL_TSE",
		market: "TSE",
	},
	...
	{
		text: "Eurozone inflation falls to 2.1%. Equity markets see fresh buying.",
		impact: 0.02,
		target: "EU",
		market: "EU",
	},
	...
	{
		text: "Siemens reports 15% jump in industrial automation revenue.",
		impact: 0.025,
		target: "SIEMENS",
		market: "EU",
	},
	...
	{
		text: "AstraZeneca cancer drug trial shows 40% higher efficacy. Stock surges.",
		impact: 0.04,
		target: "AZN",
		market: "EU",
	},
	...
	// ---- CRYPTO ----
	{
		text: "SEC approves new spot Bitcoin ETFs. Crypto markets surge 10%.",
		impact: 0.08,
		target: "BTC",
		market: "CRYPTO",
	},
	...
	{
		text: "Microsoft Azure growth slows to 25%. Misses expectations.",
		impact: -0.035,
		target: "MSFT",
		market: "NASDAQ",
	},
	...
	{
		text: "Tesla vehicle deliveries drop 10% YoY amid EV slowdown.",
		impact: -0.05,
		target: "TSLA",
		market: "NASDAQ",
	},
	...
	{
		text: "Activist investor takes 5% stake in {name}, demanding immediate board changes.",
		impact: 0.04,
		target: "RANDOM",
		market: "ALL",
	},
	{
		text: "{name} raises full-year guidance by 20%. Massive short squeeze follows.",
		impact: 0.07,
		target: "RANDOM",
		market: "ALL",
	},
	...
	{
		text: "Promoter of {name} revokes 100% of pledged shares.",
		impact: 0.04,
		target: "RANDOM",
		market: "ALL",
	},
	...
	{
		text: "Ethereum Layer 2 adoption hits all-time high. TVL surges 30%.",
		impact: 0.04,
		target: "ETH",
		market: "CRYPTO",
	},
	...
	{
		text: "Copper warehouse inventories jump 20%. Traders dump futures.",
		impact: -0.03,
		target: "COPPER",
		market: "COMM",
	},
	...
	{
		text: "Mild winter in Europe sends Natural Gas prices plunging 10%.",
		impact: -0.06,
		target: "NATGAS",
		market: "COMM",
	},
	...
	{
		text: "Defense spending in Europe increased by 2% of GDP across NATO.",
		impact: 0.02,
		target: "ALL_EU",
		market: "WAR",
	},
	...
	{
		text: "SAP Q4 cloud revenue growth exceeds 30%. Stock hits ATH.",
		impact: 0.03,
		target: "SAP",
		market: "EU",
	},
	...
	// -- US / NASDAQ (10 events) --
	{
		text: "Apple iPhone 16 sales in China drop 20% YoY. Competition bites.",
		impact: -0.03,
		target: "AAPL",
		market: "NASDAQ",
	},
	...
	{
		text: "Keyence profit margins hit 55%, highest in automation sector.",
		impact: 0.025,
		target: "KEYENCE",
		market: "TSE",
	},
	...
	{
		text: "Nissan cuts global production capacity by 15%. Restructuring begins.",
		impact: -0.03,
		target: "NISSAN",
		market: "TSE",
	},
...
function getNewsTargets(target) {
	switch (target) {
		...
		case "OILGAS":
			return {
				stocks: marketStocks.filter(function (s) {
					return s.ticker === "ONGC" || s.ticker === "BPCL";
				}),
			};
		case "ALL":
			return {
...
function setupListeners() {
	...
	document.querySelectorAll(".preset-opt").forEach(function (btn) {
		btn.addEventListener("click", function () {
			optLotsInput.value =
				parseInt(optLotsInput.value || 0) + parseInt(btn.dataset.v);
			updateOptionMargin();
		});
	});
	optLotsInput.addEventListener("input", updateOptionMargin);
	document
		.getElementById("strike-price")
		.addEventListener("change", updateOptionMargin);
	document
	...
	document
		.getElementById("btn-buy-option")
		.addEventListener("click", function () {
			executeOptionTrade("BUY");
		});
	document
		.getElementById("btn-sell-option")
		.addEventListener("click", function () {
			executeOptionTrade("SELL");
		});
	...
	document
		...
		.addEventListener("click", exportTradeHistoryCSV);
...
function tickMinute() {
	...
	if (t === 555) {
		...
		marketStocks.forEach(function (s) {
			if (
				s.ticker !== "DALAL" &&
				s.currency === "INR" &&
				!["CRYPTO", "COMM", "FX", "BOND"].includes(s.market)
			)
				resetMarketStock(s);
		});
	}
	...
	state.niftyValue = parseFloat(
		(state.niftyBase * (1 + avgChange * 2)).toFixed(2),
	);
	...
	state.sensexValue = parseFloat(
		(state.sensexBase * (1 + sensexChange)).toFixed(2),
	);
...
function executeTrade(side) {
	...
	var spread = stock.bidAskSpread || 0;
	var executionPrice =
		side === "BUY" ? stock.ltp + spread : Math.max(0.0001, stock.ltp - spread);
	var pDecimals = stock.ltp < 10 ? 4 : 2;
	executionPrice = parseFloat(executionPrice.toFixed(pDecimals));
...
function updateOptionMargin() {
	...
	document.getElementById("option-premium").textContent = fmtPrice(
		stock,
		premium,
	);
...
function executeOptionTrade(side) {
	...
	if (!isMarketOpen(stock, state.time)) {
		toast(
			"Closed",
			"Cannot trade options when " + stock.market + " is closed.",
			"error",
		);
		return;
	}
	...
	var newLots = currentPosOpt
		? currentPosOpt.lots + (side === "BUY" ? lots : -lots)
		: side === "BUY"
			? lots
			: -lots;
	...
	if (side === "BUY") {
		...
		var remainingDays =
			pos && pos.daysToExpiry != null
				? Math.max(0.01, pos.daysToExpiry - getDayFraction())
				: Math.max(0.01, getExpiryDays() - getDayFraction());
...
function renderWatchlist() {
	...
	if (needsRebuild) {
		...
		filtered.forEach(function (s) {
			...
			var sparkEl = document.createElementNS(
			...
			var polyEl = document.createElementNS(
				"http://www.w3.org/2000/svg",
				"polyline",
			);
	...
	filtered.forEach(function (s) {
		...
		var flashCls =
			s._prevTick !== undefined && s.ltp !== s._prevTick
				? s.ltp > s._prevTick
					? " flash-up"
					: " flash-dn"
				: "";
		var rowCls =
			"wl-row" + (state.activeStock === s ? " active" : "") + flashCls;
...
function closeAllPositions() {
	...
	toast(
		"Closed All",
		count + " position(s) squared off at market price",
		"success",
	);
	renderAll();
}
...
function saveSlTarget() {
	...
	if (state.slTargets[ticker].target)
		msg.push("Target " + fmtPrice(stock, tgt));
...
function renderPositionsTable() {
	...
	keys.forEach(function (ticker) {
		...
		tr.innerHTML =
			...
			ticker +
			(hasSl
				? ' <i class="fa-solid fa-bell" style="font-size:9px;color:var(--orange)"></i>'
				: "") +
			"</td>" +
			'<td class="' +
...
function calcPortfolioValue() {
	...
	if (state.fixedDeposits) {
		state.fixedDeposits.forEach(function (fd) {
			fdValue += fd.principal + (fd.interest || 0);
		}); // include accrued interest
	}
	var loanDebt = 0;
	if (state.loans) {
		state.loans.forEach(function (l) {
			loanDebt += (l.principal / l.daysTotal) * l.daysLeft;
		});
	}
	if (state.mortgages) {
		state.mortgages.forEach(function (m) {
			loanDebt += (m.principal / m.daysTotal) * m.daysLeft;
		});
	}
	var reValue = 0;
	if (state.realEstate) {
		state.realEstate.forEach(function (r) {
			reValue += r.marketPrice;
		});
	}
	return (
		state.margin +
	...
	if (state.margin < downPayment) {
		toast(
			...
			"Insufficient funds for " +
				(useMortgage ? "down payment" : "purchase") +
				". You need " +
				fmtCur(downPayment),
			"error",
		);
...
function generateRealEstateNews() {
	...
	if (Math.random() > 0.5) return { impact: 0, target: "NONE" };
